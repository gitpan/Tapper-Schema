...
PARENT_NAME = Tapper
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Tapper/Schema.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTVNAME = Tapper-Schema-3.000010
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DateTime::Format::Builder" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Tapper::TAP::Harness" VERSION="3.00001" />' >> $(DISTNAME).ppd
