...
BEGIN {
  $Tapper::Schema::ReportsDB::Result::Notification::AUTHORITY = 'cpan:TAPPER';
}
{
  $Tapper::Schema::ReportsDB::Result::Notification::VERSION = '4.1.2';
}
...
Tapper::Schema::ReportsDB::Result::Notification
